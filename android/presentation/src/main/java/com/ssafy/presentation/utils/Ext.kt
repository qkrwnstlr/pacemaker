...
fun Int.toDistance(): String = "${toString()}km"
...
val START_WITH_MIKE = listOf(
    ...
    "먼저, 여러분의 현재 체력 수준과 러닝 경험에 대해 알고 싶어요. 훈련 요일이 어떻게 되시나요?"
)
...
val START_WITH_JAMIE = listOf(
    "안녕하세요! \uD83D\uDC4B 저는 당신의 러닝 여정을 함께할 제이미 러닝 코치예요.",
    "운동을 시작하려는 당신의 결심이 정말 멋집니다. \uD83C\uDFC3\u200D♀\uFE0F✨",
    "함께 즐겁고 건강한 러닝 습관을 만들어가요!",
    "먼저 당신에 대해 조금 더 알고 싶어요. 훈련 요일이 어떻게 되시나요?"
)

val MODIFY_WITH_JAMIE = listOf(
    "안녕하세요! \uD83D\uDE04 러닝 코치 제이미예요. 플랜을 수정하러 오셨군요?",
...
val MODIFY_WITH_DANNY = listOf(
    ...
    "힘든 게 있었습니까? 아니면 더 재밌게 하고 싶은 게 있습니까? 들어보이소, 도리스 코치가 다 해결해 드리겠습니다! \uD83D\uDCAA"
)
