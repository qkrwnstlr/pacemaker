...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query("""
			...
			""")
	List<?> findMonthlyReports(String uid, Integer year, Integer month); // 사실 report 도메인에 넣어야 할 것 같음
	...
	@Query("""
			...
			""")
	List<?> findMonthlyPlanTrains(String uid, Integer year, Integer month); // plan 도메인에 넣어야 할 것 같음 (PlanTrainRepo~~)
}
