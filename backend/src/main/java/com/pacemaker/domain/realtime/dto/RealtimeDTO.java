...
@Builder
public record RealtimeDTO(@NotNull String coachId, @NotNull float totalDistance, @NotNull Integer meanHeartRate,
						  @NotNull Integer meanPace, @NotNull Integer meanCadence, @NotNull float nowDistance, @NotNull PlanTrain planTrain) {
